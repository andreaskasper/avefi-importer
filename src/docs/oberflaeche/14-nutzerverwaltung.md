...
Adresse: `/users`  
Seitentitel im Browser: „Nutzerverwaltung · AVefi Importer"  
Sprache des Dokuments: `de`

Alle Konten der Anwendung.
...
3. Hauptbereich (main), ohne Namen
  4. Bereich (region), Name „Neues Konto anlegen" — liegt innerhalb einer anderen Landmarke

### Ueberschriften

- Stufe 1: „Nutzerverwaltung"
- Stufe 2: „Neues Konto anlegen"
...
9. „Name" — Eingabefeld, im region „Neues Konto anlegen"
10. „Institution" — Auswahlfeld, im region „Neues Konto anlegen"
11. „Einmalpasswort erzeugen lassen" — Kontrollkaestchen, im region „Neues Konto anlegen"
...
- „E-Mail" — Eingabefeld, Typ email, Pflichtfeld, autocomplete off.
  Beschriftung kommt aus: label.
  Kein verknuepfter Hinweis und keine verknuepfte Fehlermeldung.
- „Name" — Eingabefeld, Typ text, Pflichtfeld, autocomplete off.
  Beschriftung kommt aus: label.
  Kein verknuepfter Hinweis und keine verknuepfte Fehlermeldung.
- „Institution" — Auswahlfeld, Typ select, kein Pflichtfeld.
  Beschriftung kommt aus: label.
  Kein verknuepfter Hinweis und keine verknuepfte Fehlermeldung.
- „Einmalpasswort erzeugen lassen" — Kontrollkaestchen, kein Pflichtfeld.
  Beschriftung kommt aus: umgebendes label.
  Kein verknuepfter Hinweis und keine verknuepfte Fehlermeldung.
- „Administrator" — Kontrollkaestchen, kein Pflichtfeld.
  Beschriftung kommt aus: umgebendes label.
  Kein verknuepfter Hinweis und keine verknuepfte Fehlermeldung.
...
Gemessen in einem Fenster von 1500 mal 1100 Pixeln. Die Seite ist 1100 Pixel hoch und passt damit ohne Scrollen. Der Kopfbereich liegt am oberen Rand ueber die volle Breite und ist 63 Pixel hoch. Die Navigation „Hauptnavigation" sitzt innerhalb der Kopfzeile, oben links. Der Hauptbereich beginnt 211 Pixel unter dem Seitenanfang und ist 1120 Pixel breit; er ist mittig gesetzt und laesst links und rechts je rund 190 Pixel frei. Der Bereich „Neues Konto anlegen" liegt auf halber Hoehe mittig und ist 1084 Pixel breit. Oben links stehen: „Zum Inhalt springen". Die breiten Schaltflaechen im Inhalt sind „Konto anlegen" (auf halber Hoehe links).
