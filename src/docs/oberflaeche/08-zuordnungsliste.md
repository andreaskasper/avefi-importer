...
10. „Bearbeiten" — Link, im main
11. „Ansehen" — Link, im main
12. „⭳ Als JSON exportieren" — Link, im main
13. „Bearbeiten" — Link, im main
14. „Ansehen" — Link, im main
15. „⭳ Als JSON exportieren" — Link, im main
16. „Ansehen" — Link, im main
17. „⭳ Als JSON exportieren" — Link, im main
18. „Bearbeiten" — Link, im main
19. „Ansehen" — Link, im main
20. „⭳ Als JSON exportieren" — Link, im main
...
- Tabelle mit 7 Spalten und 4 Datenzeilen, im main.
...
- Der Name „⭳ Als JSON exportieren" beginnt mit einem Zierzeichen und kommt 4 mal vor. Ein Vorlesewerkzeug spricht das Zeichen entweder aus oder verschluckt es; beides steht vor dem eigentlichen Namen.
- 3 mal derselbe Name „Bearbeiten" als Link im main. Es sind Zeilenaktionen einer Tabelle; beim Durchgehen der Bedienelemente sind sie nicht auseinanderzuhalten.
- 4 mal derselbe Name „Ansehen" als Link im main. Es sind Zeilenaktionen einer Tabelle; beim Durchgehen der Bedienelemente sind sie nicht auseinanderzuhalten.
- 4 mal derselbe Name „⭳ Als JSON exportieren" als Link im main. Es sind Zeilenaktionen einer Tabelle; beim Durchgehen der Bedienelemente sind sie nicht auseinanderzuhalten.
