...
**Stand:** 2026-08-31. Erzeugt gegen `https://avefiimporter.goo1.de`, gemessen in einem Fenster von 1500 mal 1100 Pixeln.
...
- [Importdetails](03-importdetails.md) — `/imports/3688f8d9-7ad2-4b27-abf0-04cd17740fea`. Ein einzelner Import mit seinem Stand und den Wegen weiter zu Zuordnung, Datensaetzen und Bericht.
- [Pruefbericht](04-pruefbericht.md) — `/imports/3688f8d9-7ad2-4b27-abf0-04cd17740fea/report`. Was die Pruefung eines Imports ergeben hat.
- [Mapping-Editor](05-mapping-editor.md) — `/imports/3688f8d9-7ad2-4b27-abf0-04cd17740fea/mapping`. Die wichtigste Seite. Hier wird jede Spalte der Quelldatei einem AVefi-Feld zugeordnet. Die Seite ist die komplexeste der Anwendung; hier verbringt ein Tester die meiste Zeit.
- [Datensatzliste](06-datensatzliste.md) — `/imports/3688f8d9-7ad2-4b27-abf0-04cd17740fea/records`. Die aus einem Import entstandenen Datensaetze als Liste.
- [Datensatz im Einzelnen](07-datensatz-detail.md) — `/imports/3688f8d9-7ad2-4b27-abf0-04cd17740fea/records/13569`. Ein einzelner Datensatz mit Werk, Manifestationen und Exemplaren.
