...
- [Importdetails](03-importdetails.md) — `/imports/3add506d-a500-4607-9f11-7e39714fffce`. Ein einzelner Import mit seinem Stand und den Wegen weiter zu Zuordnung, Datensaetzen und Bericht.
- [Pruefbericht](04-pruefbericht.md) — `/imports/3add506d-a500-4607-9f11-7e39714fffce/report`. Was die Pruefung eines Imports ergeben hat.
- [Mapping-Editor](05-mapping-editor.md) — `/imports/3add506d-a500-4607-9f11-7e39714fffce/mapping`. Die wichtigste Seite. Hier wird jede Spalte der Quelldatei einem AVefi-Feld zugeordnet. Die Seite ist die komplexeste der Anwendung; hier verbringt ein Tester die meiste Zeit.
- [Datensatzliste](06-datensatzliste.md) — `/imports/3add506d-a500-4607-9f11-7e39714fffce/records`. Die aus einem Import entstandenen Datensaetze als Liste.
- [Datensatz im Einzelnen](07-datensatz-detail.md) — `/imports/3add506d-a500-4607-9f11-7e39714fffce/records/10277`. Ein einzelner Datensatz mit Werk, Manifestationen und Exemplaren.
