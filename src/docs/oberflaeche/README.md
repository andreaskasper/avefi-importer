...
**Stand:** 2026-08-26, Commit `c6c814e`. Erzeugt gegen `https://avefiimporter.goo1.de`, gemessen in einem Fenster von 1500 mal 1100 Pixeln.
...
- [Importdetails](03-importdetails.md) — `/imports/35d78d77-6eb1-400f-8e1f-0e4ff27072ec`. Ein einzelner Import mit seinem Stand und den Wegen weiter zu Zuordnung, Datensaetzen und Bericht.
- [Pruefbericht](04-pruefbericht.md) — `/imports/35d78d77-6eb1-400f-8e1f-0e4ff27072ec/report`. Was die Pruefung eines Imports ergeben hat.
- [Mapping-Editor](05-mapping-editor.md) — `/imports/35d78d77-6eb1-400f-8e1f-0e4ff27072ec/mapping`. Die wichtigste Seite. Hier wird jede Spalte der Quelldatei einem AVefi-Feld zugeordnet. Die Seite ist die komplexeste der Anwendung; hier verbringt ein Tester die meiste Zeit.
- [Datensatzliste](06-datensatzliste.md) — `/imports/35d78d77-6eb1-400f-8e1f-0e4ff27072ec/records`. Die aus einem Import entstandenen Datensaetze als Liste.
- [Datensatz im Einzelnen](07-datensatz-detail.md) — `/imports/35d78d77-6eb1-400f-8e1f-0e4ff27072ec/records/8887`. Ein einzelner Datensatz mit Werk, Manifestationen und Exemplaren.
